...
export default function FlaggedIngredients() {
  const { recipes, substitutions, addSubstitution, ingredients } = useData()
  ...
  return (
    <div className="mb-6">
      ...
      <p className="mb-3 text-xs text-[var(--cream-dim)]">
        ...
        instead from what you carry and save — it adds a normal substitution rule, so this drops
        off the list once it's covered.
      </p>
